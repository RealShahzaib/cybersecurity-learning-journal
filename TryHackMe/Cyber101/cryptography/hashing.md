# 🔐 Hashing – Concepts, Password Security & Practical Understanding

## 🧠 Initial Understanding – What is Hashing?
...
This made me realize that hashing is not meant to “hide” data like encryption, but rather to **verify data integrity and authenticity**.

---

## 🔍 Why Hashing is Powerful (Integrity & Verification)
...
## ⚠️ Hash Collisions & Security Concerns
...
## 🔑 Hashing in Password Storage (Real-World Use)
...
## 💥 Real-World Data Breaches (Bad Password Practices)

### 1️⃣ Storing Passwords in Plaintext – RockYou Breach
...
### 2️⃣ Insecure Encryption – Adobe Breach
In Adobe’s breach, passwords were not securely hashed and some hints were stored in plaintext.  
...
### 3️⃣ Weak Hashing – LinkedIn (2012)
...
## 🧂 Password Salting – Solving the Same Password Problem
...
## 🛡️ Best Practice for Secure Password Storage
...
## 🐧 Linux Password Hashing & Shadow File
...
## 🔓 Password Cracking Tools (Hands-On)
